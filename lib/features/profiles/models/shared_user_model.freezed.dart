...
mixin _$SharedUserModel {
 ...
 String get id;@JsonKey(name: 'first_name') String? get firstName;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'first_name') String? firstName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'first_name')  String? firstName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SharedUserModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'first_name')  String? firstName)  $default,) {final _that = this;
switch (_that) {
case _SharedUserModel():
return $default(_that.id,_that.firstName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'first_name')  String? firstName)?  $default,) {final _that = this;
switch (_that) {
case _SharedUserModel() when $default != null:
return $default(_that.id,_that.firstName);case _:
  return null;
...
class _SharedUserModel extends SharedUserModel {
  const _SharedUserModel({required this.id, @JsonKey(name: 'first_name') this.firstName}): super._();
